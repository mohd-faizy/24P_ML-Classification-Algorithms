...
# Load dataset (handles running from folder or project root)
current_dir = os.path.dirname(os.path.abspath(__file__)) if '__file__' in globals() else os.getcwd()
data_path = os.path.join(current_dir, '..', '..', 'data', 'svm_dataset.csv')
if not os.path.exists(data_path):
    data_path = os.path.join('data', 'svm_dataset.csv')
